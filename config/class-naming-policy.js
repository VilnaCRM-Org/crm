 ...
 * override blocks of eslint.config.mjs. Abstract `Base*` superclasses are the one allowlist
 * carve-out: `BaseAPI` exists to be extended, so its leaf name is the subclass's.
 */

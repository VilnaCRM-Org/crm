...
import { REGISTRATION_URL, GRAPHQL_URL, userData } from './constants/constants';
...
test.describe('Registration Form', () => {
  ...
  test('displays server error on registration failure', async ({ page }) => {
    ...
    await page.route(GRAPHQL_URL, serverErrorResponse(409, { message: 'EMAIL_ALREADY_EXISTS' }));

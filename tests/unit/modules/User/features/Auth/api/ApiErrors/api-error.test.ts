...
describe('ApiError', () => {
  describe('constructor', () => {
    it('should create error with an options object', () => {
      const cause = new Error('Original error');
      const error = new ApiError({ message: 'Test error', code: 'TEST_CODE', status: 500, cause });
    ...
    it('should create error with message and code', () => {
      const error = new ApiError({ message: 'Test error', code: 'TEST_CODE' });
    ...
    it('should create error with message, code, and status', () => {
      const error = new ApiError({ message: 'Test error', code: 'TEST_CODE', status: 400 });
    ...
    it('should create error with empty message', () => {
      const error = new ApiError({ message: '', code: 'TEST_CODE' });
    ...
    it('should create error with empty code', () => {
      const error = new ApiError({ message: 'Test error', code: '' });
    ...
    it('should create error with status 0', () => {
      const error = new ApiError({ message: 'Test error', code: 'TEST_CODE', status: 0 });
    ...
    it('should create error with cause as object', () => {
      ...
      const error = new ApiError({ message: 'Test error', code: 'TEST_CODE', status: 400, cause });
  ...
  describe('edge cases', () => {
    it('should handle very long message', () => {
      ...
      const error = new ApiError({ message: longMessage, code: 'TEST_CODE' });
    ...
    it('should handle various HTTP status codes', () => {
      ...
      statuses.forEach((status) => {
        const error = new ApiError({ message: 'Test', code: 'CODE', status });
        expect(error.status).toBe(status);
      });
    });

    it('should handle negative status code', () => {
      const error = new ApiError({ message: 'Test error', code: 'TEST_CODE', status: -1 });
  ...
  describe('throw and catch', () => {
    it('should be catchable as Error', () => {
      expect(() => {
        throw new ApiError({ message: 'Test error', code: 'TEST_CODE' });
      }).toThrow(Error);
    });
    ...
    it('should work with Promise.reject', async () => {
      await expect(
        Promise.reject(new ApiError({ message: 'Test error', code: 'TEST_CODE' }))
  ...
  describe('comparison with other errors', () => {
    it('should be distinguishable from standard Error', () => {
      const apiError = new ApiError({ message: 'Test error', code: 'TEST_CODE' });

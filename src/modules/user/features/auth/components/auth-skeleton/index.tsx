  ...
  return (
    ...
    >
      <Box sx={[authFormSectionStyles.formWrapper, styles.formWrapperPulse]}>
        <UISkeletonText id="auth-skeleton-title" size="l" sx={styles.titleSkeleton} />
        <Box sx={styles.subtitleWrapper}>
          <UISkeletonText id="auth-skeleton-subtitle" size="m" sx={styles.subtitleFirstLine} />
          <UISkeletonText
        ...
        <Box sx={styles.fieldContainer}>
          <UISkeletonText id="auth-skeleton-field-label-1" size="l" sx={styles.fieldLabel} />
          <UISkeletonInput id="auth-skeleton-input-1" />
        </Box>

        <Box sx={styles.fieldContainer}>
          <UISkeletonText id="auth-skeleton-field-label-2" size="l" sx={styles.fieldLabel} />
          <UISkeletonInput id="auth-skeleton-input-2" />
        </Box>

        <Box sx={styles.lastFieldContainer}>
          <UISkeletonText id="auth-skeleton-field-label-3" size="l" sx={styles.fieldLabel} />
          <UISkeletonInput id="auth-skeleton-input-3" />
        </Box>

        <UISkeletonButton id="auth-skeleton-submit" sx={styles.buttonSkeleton} />
      ...
      <UISkeletonText id="auth-skeleton-switcher" size="l" sx={styles.switcherSkeleton} />
    </Box>
  );
}

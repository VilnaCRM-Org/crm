...
import createEmailValidator from '@/modules/User/features/Auth/components/FormSection/validations/email';
import createFullNameValidator from '@/modules/User/features/Auth/components/FormSection/validations/name';
import createPasswordValidator from '@/modules/User/features/Auth/components/FormSection/validations/password';
